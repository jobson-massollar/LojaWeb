    ...
    public partial class InitialDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClienteRGs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClienteRGs_Clientes_Id",
                        column: x => x.Id,
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS Clientes_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS ClienteRGs_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS Enderecos_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS Itens_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS Pedidos_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS Preferencias_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS Produtos_AfterUpdate;");

            migrationBuilder.Sql("DROP TRIGGER IF EXISTS UFs_AfterUpdate;");
